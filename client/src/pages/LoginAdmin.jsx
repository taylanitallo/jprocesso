            ...
            <div className="flex items-start gap-3 text-sm text-gray-600 dark:text-gray-400">
              ...
              <div>
                ...
                <p className="text-xs leading-relaxed">
                  Para acessar como município, utilize: <a href="https://www.jeossistemas.com/jprocesso/" target="_blank" rel="noopener noreferrer" className="font-mono text-blue-600 underline hover:text-blue-800">https://www.jeossistemas.com/jprocesso/nome-municipio</a>
                </p>
              </div>
            </div>
          </div>
