...
export default function DidSecaoRecebimento({ form, inp, chk, saving, didId, onSave }) {
  ...
  return (
    <SectionCard
      icon={ClipboardCheck}
      title="Seção de Recebimento — Atestado do Fiscal"
      color="bg-orange-600 text-white dark:bg-orange-800"
    >
      {/* Badge exclusivo */}
