...
export default function DidVariaveisSecaoIII({ form, inp, saving, didId, onSave, editando }) {
  ...
  return (
    <SectionCard icon={Landmark} title="Seção III - Secretaria de Finanças"
      ...
      <SecaoBotoes locked={locked} onAlterar={() => setLocked(false)} onSalvar={salvar} saving={saving} label="Salvar Seção III" editando={editando} />
    </SectionCard>
  )
}
